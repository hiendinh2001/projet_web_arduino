...
<head>
  ...
  <!-- =======================================================
  * Template Name: MediConnect
  * Updated: Sep 18 2023 with Bootstrap v5.3.2
  * Template URL: https://bootstrapmade.com/MediConnect-free-bootstrap-theme/
...
?> 
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <!-- <h1 class="logo me-auto"><a href="index.html">MediConnect</a></h1> -->
...
if ($result = mysqli_query($conn, $sql)) {
    ...
    echo '</div>';
    echo '<div class="btn-wrap" style="background-color: #ffffff;">';
    echo '<a href="#" class="btn-buy">Enregistrer</a>';
    echo '</div>';
    echo '</div>';
    echo '</section>';
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Nos Mesures</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Température</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Humidité</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Présence</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Distance (par rapport au capteur / la porte) </a></li>
    ...
    <div class="container">
      ...
      <div class="credits">
        ...
        <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/MediConnect-free-bootstrap-theme/ -->
